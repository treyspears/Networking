...
//-----------------------------------------------------------------------------------------------
void OpenGLRenderer::RenderSolidCube( const Vector3f& minCoords, float orientationDegrees, const Vector3f& axisOfRotation, const Vector3f& colorAsVec3, float scale )
{
	PushMatrix();

	glTranslatef( minCoords.x, minCoords.y, minCoords.z );
	glRotatef( orientationDegrees, axisOfRotation.x, axisOfRotation.y, axisOfRotation.z );
	glScalef( scale, scale, scale );
	
	glColor3f( colorAsVec3.x, colorAsVec3.y, colorAsVec3.z );
